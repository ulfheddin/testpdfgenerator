...
if ($_POST['form_id'] == "invoice"){
	$ticketid = $_POST['ticketid'];
	$filename = "Invoice ";
	$vat_number = $_POST['vat_number'];
	$total = "$".$_POST['total'];
	$clientdata = array (
	array ("Username", ": " . $_POST['username'], "Payment Source", ": " . $_POST['payment_source']),
	array ("Address", ": " . $_POST['name'], "Final Cost", ": " . "$" . $_POST['final_cost']),
	array ("", "  " . $_POST['address'], "",""),
	array ("", "  " . $_POST['city'], "", ""),
	array ("", "  " . $_POST['state'] . "  " . $_POST['zipcode'], "", ""),
	array ("", "  " .  $_POST['country'], "", ""),		
	);
	//Table data for invoice
...
if ($_POST['form_id'] == "invoice"){
	...
	$pdf->Cell(152,10,"Total: ",'1',0,'R',$fill);
	$pdf->Cell(30,10,$total,'1',0,'R',$fill); 
